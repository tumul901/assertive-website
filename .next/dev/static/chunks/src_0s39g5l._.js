...
_s(Enquiry, "7YX6g6Bb0KcEpRrOhsr2Ec0yHlk=", false, function() {
    return [
...
"[project]/src/components/ui/AccordionGallery.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const AccordionGallery = ({ items = DEFAULT_ITEMS, defaultIndex = 2, accentColor = '#ffffff', overlayColor = '#060010', textColor = '#ffffff', height = 460, gap = 10, radius = 16, expandRatio = 0.52, orientation = 'horizontal', duration = 0.6, ease = 'power3.out', parallax = 0.5, tilt = 8, stagger = 0.06, trigger = 'hover', showLabels = true, grayscale = true, className = '' })=>{
    ...
    const barRefs = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])([]);
    ...
    const firstRunRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(true);
    const mediaSizeRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(320);
    const vertical = orientation === 'vertical';
    const count = items.length;
    const [active, setActive] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(Math.min(Math.max(defaultIndex, 0), count - 1));
    const prefersReduced = ("TURBOPACK compile-time value", "object") !== 'undefined' && window.matchMedia ? window.matchMedia('(prefers-reduced-motion: reduce)').matches : false;
    ...
    const applyLayout = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AccordionGallery.useCallback[applyLayout]": (animate)=>{
            ...
            panels.forEach({
                "AccordionGallery.useCallback[applyLayout]": (panel, i)=>{
                    if (!panel) return;
            ...
            }["AccordionGallery.useCallback[applyLayout]"]);
            tlRef.current = tl;
        }
    }["AccordionGallery.useCallback[applyLayout]"], [
        active,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AccordionGallery.useEffect": ()=>{
            const el = rootRef.current;
            if (!el) return;
            const measure = {
                "AccordionGallery.useEffect.measure": ()=>{
            ...
            ro.observe(el);
            return ({
                "AccordionGallery.useEffect": ()=>ro.disconnect()
            })["AccordionGallery.useEffect"];
        }
    }["AccordionGallery.useEffect"], [
        applyLayout,
...
_s(AccordionGallery, "ts56FxLyKMF55+uT28EeYaVQLGE=");
_c = AccordionGallery;
const __TURBOPACK__default__export__ = AccordionGallery;
var _c;
__turbopack_context__.k.register(_c, "AccordionGallery");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_0s39g5l._.js.map